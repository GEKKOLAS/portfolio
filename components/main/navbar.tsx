...
export const Navbar = () => {
  return (
    <header>
    <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-transparent">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="https://flowbite.com" className="flex items-center">
                <img src="https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExNThiOGF4bXhyeDZnMWJhMzM1enV5anpybHBsN21zbzk2MXZ2OGRrZSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/NaxKt9aSzAspO/giphy.gif" className="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
