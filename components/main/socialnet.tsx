      ...
      <div>
        <div className="grid grid-cols-5 pt-4 text-gray-500 sm:h-6 lg:grid-cols-5 dark:text-gray-400 items-center justify-center">
          ...
          <a
            ...
            download="cv-nick.pdf"
            className="flex justify-center items-center transition-transform duration-300 hover:scale-110 hover:text-pink-500"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#d22828" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-file-down-icon lucide-file-down"><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M12 18v-6"/><path d="m9 15 3 3 3-3"/></svg>
          </a>
          {/* InfoJobs */}
          <a
            href="#"
