...
export const AnimatedTestimonials = ({
  ...
  return (
    <div className="flex justify-center items-center min-h-screen">
      <div className="sticky top-0 mx-auto max-w-sm py-20 pb-20 font-sans antialiased md:max-w-full">
      <div className="relative grid grid-cols-1 gap-12 md:grid-cols-2">
        ...
        <div className="relative h-full w-full ">
          ...
          {testimonials.map((testimonial, index) => (
            ...
            height={800}
            draggable={true}
            className="w-full h-full md:w-full md:h-full lg:w-[1200px] lg:h-[350px] 2xl:w-[1600px] 2xl:h-[600px] rounded-3xl object-cover object-center"
            />
            </motion.div>
          ))}
          </AnimatePresence>
